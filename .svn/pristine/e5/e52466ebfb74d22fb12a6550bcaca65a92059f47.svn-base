...
public class ProcedureModifierProjet extends ProjectPRC {

	private static final String PROCEDURE_NAME = "updProjet";

	public ProcedureModifierProjet() {
		// TODO Auto-generated constructor stub
	}

	public static boolean update(_CktlBasicDataBus dataBus, EOPprec projet)
			throws NSValidation.ValidationException {

		return dataBus.executeProcedure(ProcedureModifierProjet.PROCEDURE_NAME,
				ProcedureModifierProjet.construireDictionnaire(projet));
	}
	...
	private static NSDictionary construireDictionnaire(EOPprec projet) {
		...
		dicoForPrimaryKeys = EOUtilities.primaryKeyForObject(
				projet.editingContext(), projet);
		dico.takeValueForKey(Integer.valueOf(projet.primaryKey()),
				"010_a_proj_Id");
		// on cherche la cle de la no_doss
		if (projet.DirecteurPole() != null) {
			dico.takeValueForKey(projet.DirecteurPole(), "020_a_no_doss");
		} else {
			dico.takeValueForKey(null, "020_a_no_doss");
		}
		...
		if (projet.toContrat() != null)
			dico.takeValueForKey(Integer.valueOf(projet.toContrat().primaryKey()),
					"080_a_contrat");
		...
		if (projet.toAxe() != null)
			dico.takeValueForKey(Integer.valueOf(projet.toAxe().primaryKey()),
					"083_a_axe");
